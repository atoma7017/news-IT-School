...
function Home() {
  ...
  // in paranteze scriem domeniu, numarul de pagini, si numarul de stiri pe care vrem sa le afiseze. ACESTEA SUNT PARAMETRII FUNCTIEI getNews din endpoints.js
  const footballNewsEndpoint = getNewsCategoriesEndpoint("football", 1, 6);
  // const technologyData = useFetch(technologyNewsEndpoint); devin let-uri deoarece vor fi pasate ca argument
